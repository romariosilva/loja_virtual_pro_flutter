...
// // https://firebase.google.com/docs/functions/typescript
 const merchantId = functions.config().cielo.merchantid; //9b4a43f5-a6a7-401e-9436-1311da9641c3
 const merchantKey = functions.config().cielo.merchantkey; //XKRCCXGZKZRWSZTBYOMBIQFYQJLWOAELCGIJYOQR
